...
interface squareData {
  coordinates: number[]; // top - right - bottom - left
  logo: string;
  name: string;
  type: string;
  location: string;
...
const dummyData: Array<squareData> = [
  {
    coordinates: [149.89, 57.33, 169.26, 47.68],
  ...
  {
    coordinates: [149.89, 67.36, 169.26, 57.33],
  ...
  {
    coordinates: [201.62, 96.41, 221.29, 76.81],
